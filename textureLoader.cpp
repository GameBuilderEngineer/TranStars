...
{
//西川 0.22
	textureName[textureLoaderNS::STAR1] = { "TEXTURE/star1.PNG" };//西川0525
	textureName[textureLoaderNS::STAR2] = { "TEXTURE/star2.PNG" };//西川0525
	...
	textureName[textureLoaderNS::MAGIC_CIRLE] = { "TEXTURE/magic_circle.PNG" };//西川0525
